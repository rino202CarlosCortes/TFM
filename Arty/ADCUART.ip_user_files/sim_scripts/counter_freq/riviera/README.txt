...
#
# Generated by export_simulation on Tue Aug 07 15:30:49 +0200 2018
#
################################################################################
...
switch to the './counter_freq.sh' script.

./counter_freq.sh -reset_run
...
./counter_freq.sh -noclean_files

For more information on the script, please type './counter_freq.sh -help'.
