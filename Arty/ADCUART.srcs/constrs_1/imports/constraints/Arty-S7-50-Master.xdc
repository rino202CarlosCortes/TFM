...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets pin_digital]
## Switches
...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { eocsignal }]; #IO_L16N_T2_A15_D31_14 Sch=ck_io[7]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { pin_digital }]; #IO_L17P_T2_A14_D30_14 Sch=ck_io[8]
...
#set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { eocsignal }]; #IO_L14P_T2_SRCC_15 Sch=ck_io13_sck
...
set_property -dict {PACKAGE_PIN D16 IOSTANDARD LVCMOS33} [get_ports vauxp3]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports vauxn3]
